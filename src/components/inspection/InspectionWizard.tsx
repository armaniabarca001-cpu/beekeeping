  ...
  return (
    <div className="flex flex-1">
      <aside className="w-56 shrink-0 overflow-y-auto border-r border-slate-100 bg-offwhite-500 p-4">
        <Link href={`/hives/${hiveId}`} className="mb-4 block text-sm text-slate-500 hover:text-navy-500">
          &larr; Cancel
        </Link>
      ...
      <div className="flex flex-1 flex-col gap-6 overflow-y-auto p-6">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="rounded-full border border-slate-300 px-4 py-2 text-sm disabled:opacity-40"
          >
            Previous frame
          </button>
          <button
        ...
        <div className="mt-4 flex flex-col gap-3 border-t border-slate-100 pt-4">
          ...
          <button
            ...
            disabled={submitting}
            className="w-fit rounded-full bg-honey-500 px-6 py-3 font-semibold text-navy-500 hover:bg-honey-300 disabled:opacity-50"
          >
